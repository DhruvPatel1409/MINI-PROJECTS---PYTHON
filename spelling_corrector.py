...
app.resizable(0,0)
app.title("SPELLING CHECKER AND CORRECTOR")
heading_text = Label(app,text="WELCOME TO SPELLING CHECKER AND CORRECTOR APP",font='Arial 16 bold',fg='yellow',bg='black')
...
heading_text.grid(row=0,column=1,padx=20)
lbl_input.grid(row=1,column=0,padx=10)
lbl_corrected.grid(row=3,column=0,pady=10)
